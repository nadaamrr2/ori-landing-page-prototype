    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative bg-white dark:bg-[#020617] transition-colors duration-300">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 dark:text-slate-400">
          Enter your credentials to access your ORI workspace.
        </p>
      </div>
        ...
        <div className="glass-panel border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 sm:p-10 shadow-2xl">
          <form className="space-y-6" onSubmit={handleLogin} id="login-form">
            ...
            <button
              ...
              disabled={loading}
              id="login-submit-btn"
              className="w-full inline-flex items-center justify-center px-6 py-3.5 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-500/70 rounded-xl transition-all shadow shadow-blue-500/10 hover:shadow-blue-500/20 cursor-pointer"
            >
              {loading ? (
                <>
